  ...
  <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <h2 class="text-center py-5"><i class="fa-solid fa-pen-to-square"></i> Update Support Category Information</h2>
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('updateSupportCategory',$project->id)}}" method="post">
                            @csrf
...
@section('content')
<div class="container">
   <h1 class="text-center mt-3"><i class="fa-solid fa-pen-to-square"></i> Update Support Category Information</h1>
           ...
           <form action="{{route('updateSupportCategory',$project->id)}}" method="post">
               ...
               <div class="row">
                   ...
                   <div class="input-group col-lg-12 mb-4">
                       ...
                       <input value="{{$project->name}}"  type="text" name="name" placeholder="Category Name" class="form-control bg-white border-left-0 border-md" required>
                   </div>
