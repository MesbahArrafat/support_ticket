...
@section('content')
<div class="container">
   <h1 class="text-center mt-3"><i class="fa-regular fa-address-card"></i> Create an Project</h1>
           ...
           <form action="{{route('projectstore')}}" method="post">
               ...
               <div class="row">
                   ...
                   <div class="input-group col-lg-12 mb-4">
                       ...
                       <input type="text" name="name" placeholder="Project Name" class="form-control bg-white border-left-0 border-md" required>
                   </div>
                  ...
                  <div class="input-group col-lg-12 mb-4">
                   ...
                   <div class="form-group col-lg-12 mx-auto mb-0">
                       <div class="col-lg-12 py-2">
                           <button class="btn btn-primary w-100 font-weight-bold">Create your project</button>
                       </div>
                   </div>
